...
list_hash_t list_delete_key(keys_t k, list_hash_t l) { list_hash_t p=NULL, ppred=NULL;
...
list_hash_t list_concat(list_hash_t l1, list_hash_t l2) { list_hash_t c;
...
list_hash_t list_copy(list_hash_t l) { list_hash_t c,copy;
  copy=list_new();
...
list_hash_t list_inverse_copy(list_hash_t l) { list_hash_t c,copy;
  copy=list_new();
  for (c=l; !list_is_empty(c); c=c->next)
...
list_hash_t list_fusion(list_hash_t l1, list_hash_t l2) {
  ...
  list_hash_t p=list_new();
  list_hash_t l=list_new();
  list_hash_t p1=l1;
  list_hash_t p2=l2;
...
list_hash_t list_dup_n(list_hash_t l, int n) { int i=0;
  list_hash_t c,copy;
    copy=list_new();
