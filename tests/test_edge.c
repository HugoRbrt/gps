...
int main(int argc, char** argv)
{
  ...
  printf("affichage arc e1 : ");
  edge_print(e1);puts("");
  printf("affichage arc e2 : ");
  edge_print(e2);puts("");
  printf("affichage arc e3 : ");
  edge_print(e3);puts("");
  printf("affichage arc e4 : ");
  edge_print(e4);puts("");
  listedge_t l = listedge_new();

  printf("affichage liste vide : ");
  listedge_print(l);puts("");

  printf("affichage list (e1) : ");
  l = listedge_add(e1,l);
  listedge_print(l);puts("");
  ...
  l = listedge_delete(l);
  printf("taille de la liste liberee : %d",listedge_size(l));puts("");
